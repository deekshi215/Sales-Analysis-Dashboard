...
GitHub
Steps Followed
**Step 1 : Load the dataset into Microsoft Power BI Desktop. The dataset used in this project is a CSV file.
...
**Step 7 : Create measures using DAX for key metrics such as: Total Sales
...
**Step 12 : Create a comparison dashboard to compare: Sales, Profit, Quantity Sold, between two user-selected time periods.
